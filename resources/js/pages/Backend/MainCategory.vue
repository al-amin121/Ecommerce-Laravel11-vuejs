...
try{
 const response = await sendRequest({
        method: 'POST',
        url: `api/MainCategory/${id}?_method=PUT`,
   ...
   <AppLayout>
    <div class="mx-5 mt-5">
        <div class="flex justify-start">
            <h2 class="font-sans font-semibold text-3xl">Main Category</h2>
        </div>
        <div class="flex mt-5 ">
             ...
             <div class="grow pe-2 mb-20"> 
                <div class="p-5 w-96 mx-auto shadow-md shadow-primary rounded-md bg-white"> 
                    <div class="form-item h-20 mt-2 ">
                        <label for="name" class="w-48 font-sans text-xl">Main Category Name:</label>
                    ...
                    <div class="pb-5">
                        <button v-on:click="addMainCategory"  type="submit" class="flex justify-center items-center font-sans p-2 rounded-3xl w-44 h-10 bg-primary hover:bg-purple-900 text-white"
                            :disabled="isLoading"
                            >
